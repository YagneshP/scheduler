...
storiesOf("Appoinment", module)
    ...
    .add("Confirm", () => <Confirm message = "Delete the appoinment?" onConfirm = {action("onCpnfirm")} onCancel = {action("onCancel")} />)
    .add("Status", () => <Status message="Deleting"/>)
    .add("Error", () => <Error message="Could not delete appointment" onClose = {action("onClose")} />)
    .add("Edit", () => <Form student = "Yagnesh" interviewer = {2} interviewers = {interviewers} onSave = {action("onSave")} onCancel = {action("onCancel")} />)
